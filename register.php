...
<body>
    ...
    <table style="border: 2px solid black; width: 40%;" align="center">
        ...
        <tr><td>ชื่อ-นามสกุล:</td><td><input type="text" name="name-lastname" size="30"required></td></tr>
        <tr><td>เพศ:</td>
            <td>
        ...
        <tr><td>email:</td><td><input type="email" name="email" size="30" required></td></tr>
